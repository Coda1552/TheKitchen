package codyhuh.thekitchen.common.blockentities;
...
public class LittlePlatterBlockEntity extends BaseContainerBlockEntity {
    private final NonNullList<ItemStack> items = NonNullList.withSize(3, ItemStack.EMPTY);

    public LittlePlatterBlockEntity(BlockPos p_155229_, BlockState p_155230_) {
        super(ModBlockEntities.LITTLE_PLATTER.get(), p_155229_, p_155230_);
    }

    @Override
    protected Component getDefaultName() {
        return Component.translatable("container." + TheKitchen.MOD_ID + ".little_platter");
    }
